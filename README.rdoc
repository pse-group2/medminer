...
Make sure you have a mysql server installed. For Windows or Mac operating systems, there is [Apache](http://www.apachefriends.org/de/index.html), which brings all you need.
