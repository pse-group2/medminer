...
ActiveRecord::Schema.define(version: 20140320142618) do
  ...
  create_table "change_tag", id: false, force: true do |t|
    ...
    t.integer "ct_log_id"
    t.integer "ct_rev_id"
    t.binary  "ct_tag",    limit: 255, null: false
    t.binary  "ct_params"
  end
  ...
  create_table "filearchive", primary_key: "fa_id", force: true do |t|
    t.binary  "fa_name",              limit: 255,                                                                                                       null: false
    t.binary  "fa_archive_name",      limit: 255,      default: ""
    ...
    t.binary  "fa_user_text",         limit: 255
  ...
  create_table "image", primary_key: "img_name", force: true do |t|
    ...
    t.binary  "img_user_text",   limit: 255,                          null: false
  ...
  create_table "imagelinks", id: false, force: true do |t|
    ...
    t.binary  "il_to",   limit: 255,             null: false
  end
  ...
  create_table "interwiki", id: false, force: true do |t|
    t.binary  "iw_prefix", limit: 32,             null: false
    t.binary  "iw_url",                           null: false
    t.binary  "iw_api",                           null: false
    t.binary  "iw_wikiid", limit: 64,             null: false
  ...
  create_table "ipblocks", primary_key: "ipb_id", force: true do |t|
    ...
    t.binary  "ipb_by_text",          limit: 255,                                                                                                  null: false
  ...
  create_table "iwlinks", id: false, force: true do |t|
    ...
    t.binary  "iwl_title",  limit: 255,             null: false
  end
  ...
  create_table "job", primary_key: "job_id", force: true do |t|
    ...
    t.binary  "job_title",           limit: 255,             null: false
  ...
  create_table "l10n_cache", id: false, force: true do |t|
    ...
    t.binary "lc_key",   limit: 255,      null: false
  ...
  create_table "langlinks", id: false, force: true do |t|
    ...
    t.binary  "ll_title", limit: 255,             null: false
  end
  ...
  create_table "log_search", id: false, force: true do |t|
    ...
    t.binary  "ls_value",  limit: 255,             null: false
  ...
  create_table "logging", primary_key: "log_id", force: true do |t|
    ...
    t.binary  "log_user_text", limit: 255,                            null: false
    t.integer "log_namespace",             default: 0,                null: false
    t.binary  "log_title",     limit: 255,                            null: false
    t.integer "log_page"
    t.binary  "log_comment",   limit: 255,                            null: false
  ...
  create_table "oldimage", id: false, force: true do |t|
    t.binary  "oi_name",         limit: 255,                                                                                                       null: false
    t.binary  "oi_archive_name", limit: 255,                                                                                                       null: false
    ...
    t.binary  "oi_user_text",    limit: 255,                                                                                                       null: false
  ...
  create_table "protected_titles", id: false, force: true do |t|
    ...
    t.binary  "pt_title",       limit: 255, null: false
  ...
  create_table "querycache", id: false, force: true do |t|
    ...
    t.binary  "qc_title",     limit: 255,             null: false
  end
  ...
  create_table "querycachetwo", id: false, force: true do |t|
    ...
    t.binary  "qcc_title",        limit: 255,             null: false
    t.integer "qcc_namespacetwo",             default: 0, null: false
    t.binary  "qcc_titletwo",     limit: 255,             null: false
  end
  ...
  create_table "recentchanges", primary_key: "rc_id", force: true do |t|
    ...
    t.binary  "rc_user_text",  limit: 255,             null: false
    t.integer "rc_namespace",              default: 0, null: false
    t.binary  "rc_title",      limit: 255,             null: false
    t.binary  "rc_comment",    limit: 255,             null: false
    ...
    t.binary  "rc_source",     limit: 16,              null: false
  ...
  create_table "sites", primary_key: "site_id", force: true do |t|
    ...
    t.binary  "site_domain",     limit: 255, null: false
  ...
  create_table "templatelinks", id: false, force: true do |t|
    ...
    t.binary  "tl_title",     limit: 255,             null: false
  end
  ...
  create_table "uploadstash", primary_key: "us_id", force: true do |t|
    ...
    t.binary  "us_key",          limit: 255, null: false
    t.binary  "us_orig_path",    limit: 255, null: false
    t.binary  "us_path",         limit: 255, null: false
    t.binary  "us_source_type",  limit: 50
    t.binary  "us_timestamp",    limit: 14,  null: false
    t.binary  "us_status",       limit: 50,  null: false
    t.integer "us_chunk_inx"
    t.binary  "us_props"
    t.integer "us_size",                     null: false
    t.binary  "us_sha1",         limit: 31,  null: false
    t.binary  "us_mime",         limit: 255
  ...
  create_table "user", primary_key: "user_id", force: true do |t|
    t.binary  "user_name",                limit: 255,                                                                                                                                                                                                              null: false
    t.binary  "user_real_name",           limit: 255,                                                                                                                                                                                                              null: false
    ...
    t.binary  "user_email",               limit: 255,                                                                                                                                                                                                              null: false
  ...
  create_table "watchlist", id: false, force: true do |t|
    ...
    t.binary  "wl_title",                 limit: 255,             null: false
